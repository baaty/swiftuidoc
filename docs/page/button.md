...
##### 使い方
    ...
    .buttonStyle(ボタンのスタイル(ButtonStyle))

##### ボタンのスタイルの種類(ButtonStyle)

| 名前                      | 説明                         | OS                                                                    |
| ----------------------- | -------------------------- | --------------------------------------------------------------------- |
| DefaultButtonStyle()    | デフォルト                      | iOS 13.0+, macOS 10.15+, Mac Catalyst 13.0+, tvOS 13.0+, watchOS 6.0+ |
| PlainButtonStyle()      | ボタンの押された状態やフォーカスされた状態のスタイル | iOS 13.0+, macOS 10.15+, Mac Catalyst 13.0+, tvOS 13.0+, watchOS 6.0+ |
| LinkButtonStyle()       | リンクを模したボタンのためのボタンスタイル　     | macOS 10.15+                                                          |
| BorderedButtonStyle()   | 標準的なボーダーアートワークを適用するボタンスタイル | macOS 10.15+, tvOS 13.0+, watchOS 7.0+                                |
| BorderlessButtonStyle() | ボーダーを適用しないボタンのスタイル         | iOS 13.0+, macOS 10.15+, Mac Catalyst 13.0+                           |
| CardButtonStyle()       | コンテンツをパッドしないボタンスタイル        | tvOS 14.0+                                                            |
