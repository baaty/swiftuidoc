...
| 名前                                                                              | 説明                                             |
| ------------------------------------------------------------------------------- | ---------------------------------------------- |
| UIColor(white: CGFloat, alpha: CGFloat)                                         | 指定された不透明度とグレースケール値を使ってカラーオブジェクトを作成             |
| UIColor(hue: CGFloat, saturation: CGFloat, brightness: CGFloat, alpha: CGFloat) | 指定された不透明度とHSB色空間の成分値を使ってカラーオブジェクトを作成           |
| UIColor(red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat)            | 指定された不透明度とRGB成分の値を使ってカラーオブジェクトを作成              |
| UIColor(displayP3Red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat)   | Display P3の色空間で指定された不透明度とRGB成分の値でカラーオブジェクトを作成  |
