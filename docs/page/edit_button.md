...
##### 例
    ...
    EditButton()
        .actionSheet(isPresented: $isShowingSheet) {
            ActionSheet(
                title: EditButton("Permanently erase the items in the Trash?"),
                message: EditButton("You can't undo this action."),
                buttons:[
                    .destructive(EditButton("Empty Trash"),
...
##### 例
    ...
    EditButton()
        .fullScreenCover(isPresented: $isPresenting,
                         onDismiss: didDismiss) {
            VStack {
                EditButton("A full-screen modal view.")
                    .font(.title)
                EditButton("Tap to Dismiss")
            }
            .onTapGesture {
                isPresenting.toggle()
            }
...
##### 例
    ...
    EditButton()
        .alert(isPresented: $isPresented) {
            Alert(title: EditButton("Order Complete"),
                  message: EditButton("Thank you for shopping with us."),
                  dismissButton: .default(EditButton("OK")))
        }
...
##### 使い方
    ...
    .previewConEditButton(プレビュー用のコンテキスト(PreviewContext) = nil)

##### 例

    EditButton()
        .previewConEditButton(NogePreviewConEditButton(family: .systemSmall))
