...
##### 例
    ...
    RotatedShape(shape: Circle(), angle: .degrees(45))
        .mask(RotatedShape(shape: Circle(), angle: .degrees(45)).opacity(0.1))
...
| RotatedShape(shape: Circle(), angle: .degrees(45))                                                                               | 矩形の形状はそれを含むビューのフレーム内に配置        |
...
##### 例
    ...
    RotatedShape(shape: Circle(), angle: .degrees(45))
        .contentShape(RotatedShape(shape: Circle(), angle: .degrees(45)))
...
幅サイズの境界をコンテンツで埋めた結果のビュー

##### 使い方

    .strokeBorder<S>(コンテンツ(ShapeStyle), lineWidth: 幅(CGFloat) = 1, antialiased: アンチエイリアス(Bool) = true)

    .strokeBorder<S>(コンテンツ(ShapeStyle), style: スタイル(StrokeStyle), antialiased: アンチエイリアス(Bool) = true)

    .strokeBorder(lineWidth: 幅(CGFloat) = 1, antialiased: アンチエイリアス(Bool) = true)

    .strokeBorder(style: スタイル(StrokeStyle), antialiased: アンチエイリアス(Bool) = true)
