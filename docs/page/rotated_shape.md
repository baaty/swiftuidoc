...
##### 使い方
    ...
    .strokeBorder(コンテンツ(ShapeStyle), lineWidth: 幅(CGFloat) = 1, antialiased: アンチエイリアス(Bool) = true)

    .strokeBorder(コンテンツ(ShapeStyle), style: スタイル(StrokeStyle), antialiased: アンチエイリアス(Bool) = true)
