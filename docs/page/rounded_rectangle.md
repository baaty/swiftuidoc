...
##### 例
    ...
    RoundedRectangle(cornerSize: CGSize())
        .mask(RoundedRectangle(cornerSize: CGSize()).opacity(0.1))
...
| RoundedRectangle(cornerSize: CGSize())                                                       | 矩形の形状はそれを含むビューのフレーム内に配置        |
...
##### 例
    ...
    RoundedRectangle(cornerSize: CGSize())
        .contentShape(RoundedRectangle(cornerSize: CGSize()))
