...
##### 例
    ...
    ScaledShape(shape: Circle(), scale: CGSize())
        .mask(ScaledShape(shape: Circle(), scale: CGSize()).opacity(0.1))
...
| ScaledShape(shape: Circle(), scale: CGSize())                                                                                | 矩形の形状はそれを含むビューのフレーム内に配置        |
...
##### 例
    ...
    ScaledShape(shape: Circle(), scale: CGSize())
        .contentShape(ScaledShape(shape: Circle(), scale: CGSize()))
