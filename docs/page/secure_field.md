...
##### 例
    ...
    SecureField("テキスト", text: $x)
        .actionSheet(isPresented: $isShowingSheet) {
            ActionSheet(
                title: SecureField("Permanently erase the items in the Trash?"),
                message: SecureField("You can't undo this action."),
                buttons:[
                    .destructive(SecureField("Empty Trash"),
...
##### 例
    ...
    SecureField("テキスト", text: $x)
        .fullScreenCover(isPresented: $isPresenting,
                         onDismiss: didDismiss) {
            VStack {
                SecureField("A full-screen modal view.")
                    .font(.title)
                SecureField("Tap to Dismiss")
            }
            .onTapGesture {
                isPresenting.toggle()
            }
...
##### 例
    ...
    SecureField("テキスト", text: $x)
        .alert(isPresented: $isPresented) {
            Alert(title: SecureField("Order Complete"),
                  message: SecureField("Thank you for shopping with us."),
                  dismissButton: .default(SecureField("OK")))
        }
...
##### 使い方
    ...
    .previewConSecureField(プレビュー用のコンテキスト(PreviewContext) = nil)

##### 例

    SecureField("テキスト", text: $x)
        .previewConSecureField(NogePreviewConSecureField(family: .systemSmall))
