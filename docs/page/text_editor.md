...
##### 例
    ...
    TextEditor(text: $fullText)
        .accessibilityAction(named: TextEditor("Custom Action 1"), customAction1)
...
##### 例
    ...
    TextEditor(text: $fullText)
        .touchBarCustomizationLabel(TextEditor("Hearts"))
...
##### 例
    ...
    TextEditor(text: $fullText)
        .actionSheet(isPresented: $isShowingSheet) {
            ActionSheet(
                title: TextEditor("Permanently erase the items in the Trash?"),
                message: TextEditor("You can't undo this action."),
                buttons:[
                    .destructive(TextEditor("Empty Trash"),
...
##### 例
    ...
    TextEditor(text: $fullText)
        .fullScreenCover(isPresented: $isPresenting,
                         onDismiss: didDismiss) {
            VStack {
                TextEditor("A full-screen modal view.")
                    .font(.title)
                TextEditor("Tap to Dismiss")
            }
            .onTapGesture {
                isPresenting.toggle()
            }
...
##### 例
    ...
    TextEditor(text: $fullText)
        .alert(isPresented: $isPresented) {
            Alert(title: TextEditor("Order Complete"),
                  message: TextEditor("Thank you for shopping with us."),
                  dismissButton: .default(TextEditor("OK")))
        }
...
##### 使い方
    ...
    .previewConTextEditor(プレビュー用のコンテキスト(PreviewContext) = nil)

##### 例

    TextEditor(text: $fullText)
        .previewConTextEditor(hogePreviewContextEditor(family: .systemSmall))
